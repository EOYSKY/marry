...
public class ImageUtils {
  ...
  /**
   * 功能描述: <br>
   * 〈图片上传工具〉 将图片上传到服务器上Tomcat所在的路径。 并拼接处可访问的路径返回
   *
   * @param file 图片文件
   * @param targetPath 上传目标路径
   * @return 上传成功后的文件全路径
   * @author Jonny Chang
   * @version 2019/8/13 14:30
   * @since 1.0.0
   */
   ...
   * @return
   */
  public static String commpressPicForScale(
      String srcPath, String desPath, long desFileSize, double accuracy) {
